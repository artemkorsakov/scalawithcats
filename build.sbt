...
val gh = GitHubSettings(org = "com.github.artemkorsakov", proj = "scalaWithCats", publishOrg = "com.github.artemkorsakov", license = apache2)

val mainDev =
  Developer("Artem", "@artemkorsakov", "artemkorsakov@mail.ru", new java.net.URL("http://github.com/artemkorsakov"))
...
lazy val Scalawithcats = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "scalaWithCats"),
    micrositeDocumentationUrl := "/scalaWithCats/api/com.github.artemkorsakov/index.html",
